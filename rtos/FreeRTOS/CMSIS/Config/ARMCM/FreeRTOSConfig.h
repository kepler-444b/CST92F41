...
#include <stdint.h>
#include "cs_driver.h"
#include "FreeRTOS_project_config.h"
#endif
...
#define configUSE_SYSTICK                       0 // 0:PMU_TIMER 1:SYSTICK
...
#define configCPU_CLOCK_HZ                      (drv_rcc_clock_get(RCC_CLK_CPU))
#define configTICK_RATE_HZ                      ((TickType_t)1000)
#define xPortSysTickHandler                     SysTick_Handler
#else
#define configCPU_CLOCK_HZ                      (drv_rcc_clock_get(RCC_CLK_CPU))
#define configTICK_CLOCK_HZ                     ( 32768 )
#define configTICK_RATE_HZ                      ((TickType_t)1024)
#define configTICK_PERIOD                       (configTICK_CLOCK_HZ / configTICK_RATE_HZ)
#define configTICK_MAX                          (0xFFFFFFFF)
#define configTICK_TIMER_DELAY_MAX              (configTICK_MAX >> 1)
#endif
...
#define configASSERT(x)                         CS_ASSERT(x)
