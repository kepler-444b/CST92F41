 ...
 */
#if (CONFIG_SHELL)
#define UNITY_OUTPUT_CHAR(a)                       shell_out(a)
#else
...
#if defined(UNITY_INCLUDE_EXEC_TIME)
extern uint32_t osKernelGetTickCount (void);
uint32_t osKernelGetTickFreq (void);
#define UNITY_CLOCK_MS()  (osKernelGetTickCount() * 1000 / osKernelGetTickFreq())
#define UNITY_CLOCK_MS()        0
#endif
